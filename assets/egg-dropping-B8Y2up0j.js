const n={slug:"egg-dropping",metadata:{id:"puzzle-40",title:"Egg Dropping",questionPreview:`You’ve devised an egg-protection device for a school project. With two prototypes and a 100-storey building, what’s the fewest drops to find the break floor?
`,concepts:["optimisation"],difficulty:"medium",tags:["has-solution"],dateCreated:"2026-02-02",lastUpdated:"2026-02-02",credit:`Classic puzzle.
...
\`\`\`
:::`,dynamicBlocks:[{type:"dynamic",mode:"component",componentId:"#strategy-tree",props:{columns:["S","3","6"]},title:"Simple strategy: drop from floor 3, then floor 6",sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/optimisation/egg-dropping.md"},{type:"dynamic",mode:"component",componentId:"#strategy-tree",props:{columns:["S",{label:"3",chain:[1,2]},{label:"6",chain:[4,5]}],showDepth:!0},title:"Strategy tree: floors 3 and 6 with fallback chains",sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/optimisation/egg-dropping.md"},{type:"dynamic",mode:"component",componentId:"#strategy-tree",props:{columns:["S",{label:"2",chain:[1]},{label:"4",chain:[3]},{label:"6",chain:[5]}],showDepth:!0},title:"Strategy tree: floors 2, 4, and 6 with single fallbacks",sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/optimisation/egg-dropping.md"},{type:"dynamic",mode:"component",componentId:"#strategy-tree",props:{columns:["S",{label:"3",chain:[1,2]},{label:"5",chain:[4]},"6"],showDepth:!0},title:"Optimal strategy tree for 6 floors",sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/optimisation/egg-dropping.md"},{type:"dynamic",mode:"component",componentId:"#strategy-tree",props:{columns:["S",{label:"50",chain:[1,2,"...","...","...","...",49]},{label:"75",chain:[51,52,"...",74]},{label:"100",chain:[76,77,"...",98,99]}],showDepth:!0,minWidth:350},title:"Strategy tree: binary split from floor 50",sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/optimisation/egg-dropping.md"},{type:"dynamic",mode:"component",componentId:"#strategy-tree",props:{columns:["S",{label:"10",chain:{from:1,to:9}},{label:"20",chain:{from:11,to:19}},{label:"30",chain:{from:21,to:29}},"...",{label:"80",chain:{from:71,to:79},depth:17},{label:"90",chain:{from:81,to:89},depth:18},{label:"100",chain:{from:91,to:99},depth:19}],showDepth:!0,minWidth:550},title:"Strategy tree: steps of 10",sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/optimisation/egg-dropping.md"},{type:"dynamic",mode:"component",componentId:"#strategy-tree",props:{columns:["S",{label:"14",chain:{from:1,to:13}},{label:"27",chain:{from:15,to:26}},{label:"39",chain:{from:28,to:38}},{label:"50",chain:{from:40,to:49}},{label:"60",chain:{from:51,to:59}},{label:"69",chain:{from:61,to:68}},{label:"77",chain:{from:70,to:76}},{label:"84",chain:{from:78,to:83}},{label:"90",chain:{from:85,to:89}},{label:"95",chain:{from:91,to:94}},{label:"99",chain:{from:96,to:98}},"100"],showDepth:!0,minWidth:700},title:"Optimal strategy tree for 100 floors",sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/optimisation/egg-dropping.md"},{type:"dynamic",mode:"component",componentId:"#strategy-tree",props:{columns:["S",{label:"14",chain:{from:1,to:13}},{label:"27",chain:{from:15,to:26}},{label:"39",chain:{from:28,to:38}},{label:"50",chain:{from:40,to:49}},{label:"60",chain:{from:51,to:59}},{label:"69",chain:{from:61,to:68}},{label:"77",chain:{from:70,to:76}},{label:"84",chain:{from:78,to:83}},{label:"90",chain:{from:85,to:89}},{label:"95",chain:{from:91,to:94}},{label:"99",chain:{from:96,to:98}},{label:"102",chain:[100,101]},{label:"104",chain:[103]},"105"],showDepth:!0,minWidth:800},title:"Maximum building height with 14 drops: 105 floors",sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/optimisation/egg-dropping.md"}],inlineComponents:{"strategy-tree":{id:"strategy-tree",code:`// Normalize columns: expand ranges, compute full chain length
function normalizeColumns(rawColumns) {
  return rawColumns.map(col => {
    // Handle shorthand: plain string → { label: "X" }
    if (typeof col === 'string') {
...
function draw(options) {
  ...
  // Resize iframe to fit canvas
  api.requestResize(canvasHeight);
}`,startLine:310}}};export{n as default};
