const e={slug:"five-card-magic-trick-2",metadata:{id:"puzzle-draft-139",title:"Five Card Magic Trick 2",published:!1,difficulty:"hard",dateCreated:"[PLACEHOLDER]",lastUpdated:"[PLACEHOLDER]",concepts:[],preview:"This is a magic trick performed by two magicians, Alice and Bob, with one shuffled deck of N unique cards. (Nothing is mentioned about suits: you may consider...",websitePreview:"This is a magic trick performed by two magicians, Alice and Bob, with one shuffled deck of N unique cards. (Nothing is mentioned about suits: you may consider..."},content:`


<p>This is a magic trick performed by two magicians, Alice and Bob, with one shuffled deck of N unique cards. (Nothing is mentioned about suits: you may consider these cards to be simply enumerated from 1 to N.) Alice asks a member of the audience, Carol, to randomly select 5 cards out of a deck. Carol then returns her chosen 5 cards to Alice. After looking at the 5 cards, Alice picks one of the 5 cards and gives it back to Carol. Alice then arranges the other four cards in some way, and gives them to Bob in a neat, face-down pile. Bob examines these 4 cards and determines what card is in Carol's hand (the missing 5th card). Carol is astonished!</p>
<p>What is the largest number of cards N that the deck can contain before the trick is no longer performable? Prove it.<br>
How specifically do you execute the trick on a deck of maximal size N?<br>
Note 1: There's no secretive message communication in the solution, like encoded speech or ninja hand signals or ESP or whatever ... the only communication between the two magicians is encoded in the 4 cards transferred from Alice to Bob. Think of these magicians as mathematicians.</p>
<p>Note 2: Essentially, this is the same 5 card magic trick, but now I am challenging you to get away with it using a deck larger than 52 playing cards.</p>`,rawContent:`<!-- Difficulty: \\[todo\\] -->
<!-- Tags: \\[todo\\] -->
