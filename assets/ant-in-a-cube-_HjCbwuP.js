...
}`,startLine:58},"cube-net":{id:"cube-net",code:`function draw(options) {
  const { canvas, api, width } = options;
  const ctx = canvas.getContext('2d');
...
}`,startLine:206}}};export{n as default};
