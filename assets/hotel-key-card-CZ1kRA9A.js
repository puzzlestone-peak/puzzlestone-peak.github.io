const e={slug:"hotel-key-card",metadata:{id:"puzzle-draft-168",title:"Hotel Key Card",published:!1,difficulty:{concepts:"easy",reasoning:"easy"},concepts:[],tags:[],dateCreated:"[PLACEHOLDER]",lastUpdated:"[PLACEHOLDER]",preview:"A certain hotel room lock is opened by scanning a key card. In theory, one enters the room by inserting and removing the key card once. In practice, however,...",websitePreview:"A certain hotel room lock is opened by scanning a key card. In theory, one enters the room by inserting and removing the key card once. In practice, however,..."},content:`
