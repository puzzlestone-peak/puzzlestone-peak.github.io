const e={slug:"fastest-3-in-25-horses",metadata:{id:"puzzle-11",title:"Fastest 3 in 25 Horses",difficulty:{concepts:"medium",reasoning:"medium"},concepts:["optimisation","logic"],tags:["has-solution"],credit:"Classic puzzle, commonly used in technical interviews. Question and solution written by Puzzlestone Peak.",dateCreated:"2025-11-02",lastUpdated:"2025-11-02",changelog:"2025-11-03: Added to Puzzlestone Peak",preview:"You visit a farm, hoping to buy the 3 fastest horses they have. The farmer says he has 25 horses, but he has no idea how fast each of them are. Instead, he...",websitePreview:"You visit a farm, hoping to buy the 3 fastest horses they have. The farmer says he has 25 horses, but he has no idea how fast each of them are. Instead, he..."},content:`<p>You visit a farm, hoping to buy the 3 fastest horses they have. The farmer says he has 25 horses, but he has no idea how fast each of them are. Instead, he gives you access to a race track that allows 5 horses to run at a time. Neither you nor the farmer have a stopwatch on hand. What is the minimum number of races required to find the 3 fastest horses?</p>
...
\`\`\`
:::`,dynamicBlocks:[{type:"dynamic",mode:"component",componentId:"#diagram",props:{stage:"stage-1"},title:"After races 1-5: Horses ranked within each group",sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/optimisation/fastest-3-in-25-horses.md"},{type:"dynamic",mode:"component",componentId:"#diagram",props:{stage:"stage-2"},title:"After race 6: Groups ranked by fastest horse (A1 is overall fastest)",sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/optimisation/fastest-3-in-25-horses.md"},{type:"dynamic",mode:"component",componentId:"#diagram",props:{stage:"stage-3"},title:"After elimination: 5 remaining candidates for 2nd and 3rd place",sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/optimisation/fastest-3-in-25-horses.md"}],inlineComponents:{diagram:{id:"diagram",code:`const HORSE_SVG = \`<svg xmlns="http://www.w3.org/2000/svg" viewBox="41.97 41.8 200.06 187.89"><path fill="currentColor" d="M42.1 80.5c1 1.1 1.4 4.7 4 6.6s5.2 2.4 5.8.6c.6-1.7 8.1-4.8 13.7-5.3 5.7-.5 6.8-1.2 8.8-2.5s2.5-.4 4.4 1.5 1.6 14.8 2 21.1c.3 6.3 4.6 16.9 4.6 16.9s2.4 7.6.9 14.8c-1.5 7.1 9.3 12.6 8.8 16.1-.6 3.5 5.2 12.7 5.3 16.6s2.6 20.5 3.6 23.3.9 12.7.7 15.6-1.7 7.3-3.2 9c-1.5 1.6-2.7 3.9-3.9 5.6-1.3 1.6-3.1 4.2-3.1 4.2 8.2 2 10.9-1.1 12.4-2.8s2.4-3 2.4-4.5c-.1-1.5-2-1.7-.7-3.6s2.7-2.6 3.5-4.4-1.2-18 .6-21.6 1.7-9.5 2.1-16.2 2-18.4 2-18.4c4 3.6 33.5.9 40.4.2 7-.7 16.5-5 19-4.7s3.3 3.1 4.4 3.5c1.1.3 4.2-1.6 4.2-1.6s5.6 6.7 6.3 8.9 7.5 15.4 7.9 19.8 2.9 9.7 3.8 13.7-3.2 19.6-4.1 22.8c-.9 3.1-3.1 5-4.5 5.9-1.3.9-3.9 5.4-4.9 6.7-1 1.2 8.5 2.4 11.8 0s.8-5.2.4-6c-.4-.9 1.5-2.9 2.7-3.7 1.3-.8 2.7-1.7 2.4-4.6-.2-2.8 3.1-23.9 5.2-29.7s-.2-6.7-1.2-7.9c-.9-1.3-2.8-9.3-2.8-9.3s8.9 9.7 9.3 13.4c.4 3.8 3.8 6.7 5.3 9s3 16.8 3.3 21.8c.3 4.9-1.2 7.5-2 8.7-.9 1.3-1.2 2.8-1.2 2.8l-3.5 4.6s7.9 1.7 10.2.5c2.4-1.3 3.1-4.2 1.3-6.3-1.8-2-1-3.8 1.5-6.6s-3.1-25.4-3.1-27.6c-.1-2.1 2.2-4.6 6.4-15.7s5.7-23 6.7-44.7-21-26.5-25.2-26.6-11.7 1.2-11.7 1.2c-5.7-2.8-25.7-4.5-37.1-.3s-25.1 2.5-35.6-.5c-10.4-3.1-20.7-27.6-31.6-38.7-11.1-11.5-26.4-13.8-26.4-13.8-1.1-3.8-3.5-4.8-3.5-4.8.3 2-.1 3.6-.1 3.6-1.7-.9-3.6-5.3-3.6-5.3-1.4 1.9.3 8.8.3 8.8s-1.3 1.4-4.9 3.5-9 16.1-12.3 18.1c-3.1 1.9-9.3 7.2-8.2 8.3zm174.2 61.1c1.2-2.1 2.9-14.4 3.5-19 .1-.9.1-4.4.3-5.6.4-1.9.4 1.2.4 2-.3 4.4-1.1 19.7-.6 23.1.6 4.1 4.4 20.2.4 25 0 0-4.8-8.3-5-11.1-.3-2.7-.4-12 1-14.4z"/><path fill="currentColor" d="M216.3 177s-1.9 6.1-1.5 9.5c.4 3.5 3.1 10.3 2.7 13 0 0 6.1-5.7 8-12.1"/></svg>\`
...
}`,layout:'<div id="container" class="grid grid-cols-5 grid-rows-5 gap-4 max-w-[500px] m-auto p-1"></div>',startLine:77}}};export{e as default};
