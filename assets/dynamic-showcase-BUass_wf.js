const n={slug:"dynamic-showcase",metadata:{id:"dev-puzzle-1",title:"Dynamic Content Showcase",concepts:[],difficulty:{concepts:"easy",reasoning:"easy"},tags:["developer"],dateCreated:"2025-10-27",lastUpdated:"2025-10-27",published:"dev-only",preview:"Dynamic Content Showcase This puzzle demonstrates all the different ways to create interactive and visual content using the DynamicBlock system. 1. DOM Mode -...",websitePreview:"Dynamic Content Showcase This puzzle demonstrates all the different ways to create interactive and visual content using the DynamicBlock system. 1. DOM Mode -..."},content:`<h2 class="markdown-h1">Dynamic Content Showcase</h2>
...
`,dynamicBlocks:[{type:"dynamic",mode:"dom",code:`function mount(options) {
  ...
  container.appendChild(buttonRow);
  root.appendChild(container);
}`,sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/developer/dynamic-showcase.md",startLine:25},{type:"dynamic",mode:"dom",code:`function mount(options) {
  const { root, api, props } = options;
  const [flipBtn] = api.ui.button('.flip-btn', { variant: 'contained', color: 'accent' });
  const result = root.querySelector('.result');
  ...
  <div class="result text-2xl font-bold text-center p-4 bg-muted rounded">Heads</div>
  <button class="flip-btn">Flip Coin</button>
</div>`,sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/developer/dynamic-showcase.md",startLine:92},{type:"dynamic",mode:"dom",code:`function draw(options) {
  const { canvas, api, theme, width, props } = options;
  const ctx = canvas.getContext('2d');
  const height = Math.floor(width * 0.4);
  ...
  <canvas id="scene"></canvas>
</div>`,sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/developer/dynamic-showcase.md",startLine:123},{type:"dynamic",mode:"dom",code:`// Disable auto-redraw, use manual control
const autoRedraw = {
  onThemeChange: false,
  onResize: false
};
...
function mount(options) {
  ...
  <button class="redraw-btn">Redraw Now</button>
</div>`,sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/developer/dynamic-showcase.md",startLine:173},{type:"dynamic",mode:"dom",code:`function mount(options) {
  const { root, api, props } = options;
  // Button variants
  const buttonContainer = root.querySelector('.flex.flex-wrap.gap-2');
  const buttonVariants = [
...
</div>`,sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/developer/dynamic-showcase.md",startLine:269},{type:"dynamic",mode:"dom",code:`function mount(options) {
  const { root, api, props } = options;
  const button = root.querySelector('.custom-button');
  button.addEventListener('click', () => {
    alert('Custom CSS styling is powerful!');
...
.custom-button:active {
  transform: translateY(0);
}`,sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/developer/dynamic-showcase.md",startLine:444},{type:"dynamic",mode:"component",componentId:"#counter",props:{start:0},sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/developer/dynamic-showcase.md"},{type:"dynamic",mode:"component",componentId:"#counter",props:{start:100},sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/developer/dynamic-showcase.md"},{type:"dynamic",mode:"component",componentId:"#counter",props:{start:-50},sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/developer/dynamic-showcase.md"},{type:"dynamic",mode:"component",componentId:"nim-game-sample",sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/developer/dynamic-showcase.md"},{type:"dynamic",mode:"component",componentId:"nim-game-sample",props:{startingPiles:[1,3,5,7],allowReset:!1},sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/developer/dynamic-showcase.md"},{type:"dynamic",mode:"component",componentId:"nim-game-sample",props:{startingPiles:[2,4],showStatus:!1},sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/developer/dynamic-showcase.md"},{type:"dynamic",mode:"component",componentId:"nim-game-sample",props:{startingPiles:[2,3,5,7,9],allowReset:!0,showStatus:!0},sourceFile:"/home/runner/work/puzzlestone-peak/puzzlestone-peak/apps/web/content/puzzles/developer/dynamic-showcase.md"}],inlineComponents:{counter:{id:"counter",code:`function mount(options) {
  const { root, api, props } = options;
  let count = props.start || 0;
  const container = document.createElement('div');
  container.className = api.css('flex flex-col items-center gap-3 p-4 bg-card rounded-lg border border-border');
  ...
  container.appendChild(btnRow);
  root.appendChild(container);
}`,startLine:460}}};export{n as default};
