const n={slug:"nim-game-variations",metadata:{id:"7",title:"Nim Game: Multi-Pile Variations",concepts:["game-theory","strategy","nim","binary","xor"],difficulty:"advanced",tags:["game","series","mathematical","binary"],dateCreated:"2025-10-22T00:00:00.000Z",lastUpdated:"2025-10-22T00:00:00.000Z",previousPuzzle:"nim-game-strategy",preview:"Classic Multi-Pile Nim The rules: Start with several piles of stones (e.g., piles of 3, 5, and 7 stones) Players alternate turns On your turn, remove any...",websitePreview:"Classic Multi-Pile Nim The rules: Start with several piles of stones (e.g., piles of 3, 5, and 7 stones) Players alternate turns On your turn, remove any..."},content:`<h2 class="markdown-h1">Classic Multi-Pile Nim</h2>
<p>The rules:</p>
<ul>
...
:::
`,dynamicBlocks:[]};export{n as default};
