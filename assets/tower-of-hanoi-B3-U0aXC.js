const s={slug:"tower-of-hanoi",metadata:{title:"The Tower of Hanoi",questionPreview:`You have three rods and n disks of different sizes. Move all disks from the first rod to the third, moving one disk at a time, never placing a larger disk on a smaller one. What's the minimum number of moves?
`,concepts:["recursion","algorithms","mathematical-induction"],difficulty:"advanced",tags:["classic","recursive","algorithmic"],dateCreated:"2025-10-22T00:00:00.000Z",lastUpdated:"2025-10-22T00:00:00.000Z"},content:`<h2 class="markdown-h1">The Puzzle</h2>
<p>You have:</p>
<ul>
