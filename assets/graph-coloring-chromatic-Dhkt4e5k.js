const s={slug:"graph-coloring-chromatic",metadata:{title:"Graph Colouring: Chromatic Numbers",questionPreview:`The chromatic number of a graph is the minimum number of colours needed to colour its vertices so no adjacent vertices share a colour. How do we determine this number for any graph?
`,concepts:["graph-theory","colouring","chromatic-number","algorithms"],difficulty:"advanced",tags:["series","computational","NP-complete"],dateCreated:"2025-10-22T00:00:00.000Z",lastUpdated:"2025-10-22T00:00:00.000Z",previousPuzzle:"graph-coloring-intro",nextPuzzle:"graph-coloring-four-color"},content:`<h2 class="markdown-h1">The Chromatic Number</h2>
