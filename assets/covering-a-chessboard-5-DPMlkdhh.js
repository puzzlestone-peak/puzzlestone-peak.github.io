const e={slug:"covering-a-chessboard-5",metadata:{id:"puzzle-draft-64",title:"Covering a Chessboard 5",published:!1,difficulty:"medium",concepts:[],tags:[],dateCreated:"[PLACEHOLDER]",lastUpdated:"[PLACEHOLDER]",preview:"You’re given an 8x8 chessboard. You can place S tetrominos on the board, with each one covering exactly 4 tiles. These pieces can be rotated by 90° increments...",websitePreview:"You’re given an 8x8 chessboard. You can place S tetrominos on the board, with each one covering exactly 4 tiles. These pieces can be rotated by 90° increments..."},content:`<h3 class="markdown-h2">You’re given an 8x8 chessboard. You can place S tetrominos on the board, with each one covering exactly 4 tiles. These pieces can be rotated by 90° increments or flipped. Can you cover the entire chessboard? If yes, show an arrangement of such a covering. If not, prove why it cannot be done.</h3>
