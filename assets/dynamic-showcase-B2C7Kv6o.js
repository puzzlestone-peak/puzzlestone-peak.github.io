const n={slug:"dynamic-showcase",metadata:{id:"18",title:"Dynamic Content Showcase",concepts:[],difficulty:"easy",tags:["developer"],dateCreated:"2025-10-27T00:00:00.000Z",lastUpdated:"2025-10-27T00:00:00.000Z",published:"dev-only",preview:"Dynamic Content Showcase This puzzle demonstrates all the different ways to create interactive and visual content using the DynamicBlock system. 1. DOM Mode -...",websitePreview:"Dynamic Content Showcase This puzzle demonstrates all the different ways to create interactive and visual content using the DynamicBlock system. 1. DOM Mode -..."},content:`<h2 class="markdown-h1">Dynamic Content Showcase</h2>
...
<hr>
<h3 class="markdown-h2">8. Testing Dynamic Hyperlinks</h3>
...
<ul>
<li>Link to a puzzle: <a href="/puzzle/two-doors">The Two Doors</a></li>
<li>Link to an expedition: <a href="/expedition/basic-deduction">Introduction to Logic Puzzles</a></li>
<li>Link to another puzzle: <a href="/puzzle/nim-game-basics">Nim Game: The Basics</a></li>
...
<ul>
<li>With anchor: <a href="/puzzle/nim-game-basics#hints">Nim Game: The Basics</a></li>
<li>With query param: <a href="/puzzle/two-doors?hint=1">The Two Doors</a></li>
<li>With both: <a href="/puzzle/nim-game-strategy?hint=1#solution">Nim Game: Winning Strategy</a></li>
</ul>
...
<li><a href="/expedition/basic-deduction" class="font-bold text-primary">Basic deduction expedition</a></li>
...
- Link to a puzzle: [The Two Doors](puzzle:two-doors)
- Link to an expedition: [Introduction to Logic Puzzles](expedition:basic-deduction)
- Link to another puzzle: [Nim Game: The Basics](puzzle:nim-game-basics)
...
- With anchor: [Nim Game: The Basics](puzzle:nim-game-basics#hints)
- With query param: [The Two Doors](puzzle:two-doors?hint=1)
- With both: [Nim Game: Winning Strategy](puzzle:nim-game-strategy?hint=1#solution)
